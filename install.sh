...
pre_install_docker_compose(){
    ...
    read -p "(image address (Default sk9527sk9527/v2ray_v3:go_pay):" docker_addresss
    [ -z "${docker_addresss}" ] && docker_addresss="sk9527sk9527/v2ray_v3:go_pay"
    echo
    echo "---------------------------"
...
install_docker(){
    ...
    curl -L https://github.com/docker/compose/releases/download/v2.24.0/docker-compose-`uname -s`-`uname -m` > /usr/local/bin/docker-compose
